...
local backgroundImage = Material("materials/charmenu/bg.png")
...
do
	...
	sound.Add({
		...
		level = 80,
		pitch = {95, 105},
		sound = bRollover and "charmenu/hover.wav" or "ui/buttonrollover.wav"
	})
	...
	sound.Add({
		...
		sound = bPress and "charmenu/select.wav" or "ui/buttonclickrelease.wav"
	})
